...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/ntak-guru-php-sdk.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/ntak-guru-php-sdk)
...
```php
$skeleton = new TmrwLife\NtakGuru();
echo $skeleton->echoPhrase('Hello, TmrwLife!');
```
